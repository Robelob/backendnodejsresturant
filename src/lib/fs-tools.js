...
const full_Authors_JSONpath = join(dataFolderPath, "author.json");
...
export const writeBlogPostJson = (content) =>
  writeJSON(full_blogPost_JSONpath, content); //writting on blogpost.json and stringfy as json mode

export const readfeedbackJson = () => readJSON(full_Authors_JSONpath);
export const writefeedbackJson = (content) =>
  writeJSON(full_Authors_JSONpath, content);

export const saveBlogPostPictures = (fileName, contentAsBuffer) =>
